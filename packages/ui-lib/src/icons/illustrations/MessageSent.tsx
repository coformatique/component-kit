...
export const MessageSentIllustration = (props: SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 144 105" fill="none" {...props}>
        <g clip-path="url(#clip0_2646_10338)">
            ...
            />
            <path
                d="M10.8174 83.4013C21.44 94.0239 37.141 92.4649 58.1809 71.4251"
                stroke="white"
                stroke-dasharray="4 5"
            />
            <path
            ...
            />
            <path
                d="M106.789 71.9542L72.8545 58.0719L118.358 1L106.789 71.9542Z"
                stroke="black"
                stroke-linejoin="round"
            />
            <path
                d="M118.357 1L40.4619 44.1895L62.8279 53.4444L118.357 1.77124"
                stroke="black"
                stroke-linejoin="round"
            />
