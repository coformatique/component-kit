...
const Template: Story = args => (
  ...
  >
    ...
    <Box sx={{ bgcolor: '#ddd', overflow: 'auto' }} gridArea="D">
      {[...Array(args.repeat)].map((_, i) => (
        <Typography key={i}>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Necessitatibus quam consequuntur aperiam quo quis
          officia voluptatem culpa temporibus, tenetur aspernatur commodi harum eaque quidem, voluptates ea! Impedit
          eligendi officiis quia?
        </Typography>
      ))}
    </Box>
  </Box>
