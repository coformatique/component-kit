    ...
    <DropdownSelectLayout fieldError={fieldError} fullWidth={rest.fullWidth} tooltipText={tooltipText} margin={margin}>
      ...
      <StyledTextField
        ...
        InputLabelProps={{
          ...
          shrink: !!inputText || parentSelectedItems.length > 0 || document.activeElement === inputRef.current,
        }}
...
export const AppDropdownMultiselectField = (props: AppDropdownMultiselectFieldProps) => {
  ...
  return (
    ...
    <AppDropdownMultiselect
      ...
      {...props}
      selectedItems={value ?? []}
      setSelectedItems={items => setValue(name, items, { shouldDirty: true, shouldTouch: true, shouldValidate: true })}
      fieldError={error}
