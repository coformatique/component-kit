    ...
    <Grid container spacing={3} width={500} m="auto">
      <Grid item xs={12}>
        <AppCard header={{ title: 'Faulty Card' }} error={error}>
          Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vero tenetur rem nostrum reprehenderit facere nulla
          a harum qui tempora totam! Doloribus incidunt delectus ut illo pariatur, quis molestias sunt dolor?
        </AppCard>
      </Grid>
      <Grid item xs={12}>
        <AppForm
